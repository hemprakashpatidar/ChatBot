 ...
 * @author HP
 */
@WebServlet(name="UserNewQuerry", urlPatterns={"/UserNewQuerry"})
public class UserNewQuerry extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
           String q=request.getParameter("NQuerry");
          
           out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UserNewQuerry</title>");
            out.println("</head>");
            out.println("<body>");
